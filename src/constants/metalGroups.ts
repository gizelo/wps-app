export const METAL_GROUPS = [
  {
    GroupNumber: "1",
    Description:
      "Steels with a specified minimum yield strength ReH ≤ 460 N/mm2 a and with analysis in %: C ≤ 0,25 Si ≤ 0,60 Mn ≤ 1,8 Mo ≤ 0,70 b S ≤ 0,045 P ≤ 0,045 Cu ≤ 0,40 b Ni ≤ 0,5 b Cr ≤ 0,3 (0,4 for castings) b Nb ≤ 0,06 V ≤ 0,1 b Ti ≤ 0,05",
    Subgroups: [
      {
        GroupNumber: "1.1",
        Description:
  ...
  },
  {
    ...
    Subgroups: [
      {
        GroupNumber: "4.1",
        Description: "Steels with Cr ≤ 0,3 % and Ni ≤ 0,7 % ",
      },
      {
        GroupNumber: "4.2",
        Description: "Steels with Cr ≤ 0,7 % and Ni ≤ 1,5 % ",
      },
    ],
  },
  {
    GroupNumber: "5",
    Description: "Cr-Mo steels free of vanadium with C ≤ 0,35 %",
    Subgroups: [
      {
        GroupNumber: "5.1",
        Description: "Steels with 0,75 % ≤ Cr ≤ 1,5 % and Mo ≤ 0,7 % ",
      },
      {
        GroupNumber: "5.2",
        Description: "Steels with 1,5 % < Cr ≤ 3,5 % and 0,7 % < Mo ≤ 1,2 % ",
      },
      {
        GroupNumber: "5.3",
        Description: "Steels with 3,5 % < Cr ≤ 7,0 % and 0,4 % < Mo ≤ 0,7 % ",
      },
      {
        GroupNumber: "5.4",
        Description: "Steels with 7,0 % < Cr ≤ 10,0 % and 0,7 % < Mo ≤ 1,2 % ",
      },
    ],
  },
  {
    GroupNumber: "6",
    Description: "High vanadium alloyed Cr-Mo-(Ni) steels",
    Subgroups: [
      {
        GroupNumber: "6.1",
        Description:
  ...
  },
  {
    ...
    Subgroups: [
      ...
      {
        GroupNumber: "7.3",
        Description: "Precipitation-hardened stainless steels ",
      },
    ],
  },
  {
    GroupNumber: "8",
    Description: "Austenitic stainless steels, Ni ≤ 31 %",
    Subgroups: [
      {
        GroupNumber: "8.1",
        Description: "Austenitic stainless steels with Cr ≤ 19 % ",
      },
      {
        GroupNumber: "8.2",
        Description: "Austenitic stainless steels with Cr > 19 % ",
  ...
  {
    GroupNumber: "9",
    Description: "Nickel alloy steels with Ni ≤ 10,0 %",
    Subgroups: [
      {
        GroupNumber: "9.1",
        Description: "Nickel alloy steels with Ni ≤ 3,0 % ",
      },
      {
        GroupNumber: "9.2",
        Description: "Nickel alloy steels with 3,0 % < Ni ≤ 8,0 % ",
      },
      {
        GroupNumber: "9.3",
        Description: "Nickel alloy steels with 8,0 % < Ni ≤ 10,0 % ",
      },
    ],
  },
  {
    GroupNumber: "10",
    Description: "Austenitic ferritic stainless steels (duplex)",
    Subgroups: [
      {
        GroupNumber: "10.1",
        Description: "Austenitic ferritic stainless steels with Cr ≤ 24 % ",
      },
      {
        GroupNumber: "10.2",
        Description: "Austenitic ferritic stainless steels with Cr > 24 % ",
  ...
  {
    GroupNumber: "11",
    Description: "Steels covered by group 1 c except 0,25 % < C ≤ 0,85 %",
    Subgroups: [
      {
        GroupNumber: "11.1",
        Description:
      ...
      {
        GroupNumber: "11.2",
        Description: "Steels as indicated in group 11 with 0,35 % < C ≤ 0,5 % ",
      },
      {
        GroupNumber: "11.3",
        Description: "Steels as indicated in group 11 with 0,5 % < C ≤ 0,85 % ",
      },
    ],
  },
  {
    GroupNumber: "21",
    Description: "Pure aluminium with ≤ 1 % impurities or alloy content",
  },
  {
    GroupNumber: "22",
    Description: "Non-heat-treatable alloys",
    Subgroups: [
      {
        GroupNumber: "22.1",
        Description: "Aluminium-manganese alloys ",
      },
      {
        GroupNumber: "22.2",
        Description: "Aluminium-magnesium alloys with Mg ≤ 1,5 % ",
      },
      {
        GroupNumber: "22.3",
        Description: "Aluminium-magnesium alloys with 1,5 % < Mg ≤ 3,5 % ",
      },
      {
        GroupNumber: "22.4",
        Description: "Aluminium-magnesium alloys with Mg > 3,5 % ",
      },
    ],
  },
  {
    GroupNumber: "23",
    Description: "Heat-treatable alloys ",
    Subgroups: [
      {
        GroupNumber: "23.1",
        Description: "Aluminium-magnesium-silicon alloys ",
      },
      {
        GroupNumber: "23.2",
        Description: "Aluminium-zinc-magnesium alloys ",
      },
    ],
  },
  {
    GroupNumber: "24",
    Description: "Aluminium-silicon alloys with Cu ≤ 1 %",
    Subgroups: [
      {
        GroupNumber: "24.1",
        Description:
  ...
  {
    GroupNumber: "26",
    Description: "Aluminium-copper alloys with 2 % < Cu ≤ 6 %",
  },
  {
    GroupNumber: "31",
    Description: "Copper with up to 6 % Ag and 3 % Fe",
  },
  {
    GroupNumber: "32",
    Description: "Copper-zinc alloys",
    Subgroups: [
      {
        GroupNumber: "32.1",
        Description: "Copper-zinc alloys, binary ",
      },
      {
        GroupNumber: "32.2",
        Description: "Copper-zinc alloys, complex ",
      },
    ],
  },
  {
    GroupNumber: "33",
    Description: "Copper-tin alloys",
  },
  {
    GroupNumber: "34",
  ...
  {
    GroupNumber: "35",
    Description: "Copper-aluminium alloys",
  },
  {
    GroupNumber: "36",
    Description: "Copper-nickel-zinc alloys",
  },
  {
    GroupNumber: "37",
    Description:
  ...
  {
    GroupNumber: "73",
    Description: "Malleable cast irons",
    Subgroups: [
      {
        GroupNumber: "73.1",
        Description: "Malleable cast irons",
  ...
  {
    GroupNumber: "74",
    Description: "Austempered ductile cast irons",
  },
  {
    GroupNumber: "76",
    Description: "Cast irons excepting groups 71 to 75",
    Subgroups: [
      {
        GroupNumber: "76.1",
        Description: "Cast irons excepting groups 71 to 75",
